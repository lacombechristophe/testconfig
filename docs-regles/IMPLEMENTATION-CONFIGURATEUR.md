...
- **estimation indicative** : calcul source exploitable mais remise, fiscalité, pose ou validation fabricant encore à confirmer ;
...
Ces champs sont validés et bornés côté serveur, puis affichés dans les e-mails prospect et interne. Pour Oré, les e-mails conservent la mention « fiscalité à confirmer » et n'annoncent pas un TTC certain.
...
- Oré : régime fiscal de la matrice, règle unique de remise options, pose, recul et couleur hors standard ;
- BAB : PU/remise/transport de la grille versus devis du 6 juillet 2026 et garantie 3/10 ans ;
- volets : remises du devis versus simulateurs, régime fiscal de la table transport, escaliers et options avancées ;
- abris : règle officielle du nombre de modules, catalogue HT/TTC de pose, zones de livraison et dépendances d'options ;
