(function (root) {
  ...
  var definitions = {
    ...
    cover: { viewBox: '0 0 64 48', body: '<path d="M13 7h38l9 14v8H4v-8L13 7Z"/><path d="M5 21h54M5 29h54"/><path d="M4 38c4 0 4 3 8 3s4-3 8-3 4 3 8 3 4-3 8-3 4 3 8 3 4-3 8-3 4 3 8 3"/>' },
    bars: { body: '<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M4 8h16M4 12h16M4 16h16"/>' },
    shutter: { viewBox: '0 0 64 48', body: '<rect x="7" y="5" width="50" height="31" rx="2.5"/><path d="M12 11h40M12 17h40M12 23h40M12 29h40"/><path d="M7 38c3.6 0 3.6 3 7.2 3s3.6-3 7.2-3 3.6 3 7.2 3 3.6-3 7.2-3 3.6 3 7.2 3 3.6-3 7.2-3 3.6 3 7.2 3"/>' },
    shelter: { viewBox: '0 0 64 48', body: '<path d="M5 39V24C5 14 13 6 23 6s18 8 18 18v15"/><path d="M23 39V21c0-8 6.7-15 15-15s15 7 15 15v18"/><path d="M14 39V26c0-5 4-9 9-9M32 39V23c0-5 4-9 9-9M3 39h57"/>' },
    deck: { viewBox: '0 0 64 48', body: '<path d="m32 6 29 11-29 11L3 17 32 6Z"/><path d="M3 24.5 32 35l29-10.5M3 32 32 42l29-10"/>' },
